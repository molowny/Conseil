...
trait BitcoinFixtures {
  ...
  object RpcFixtures {
    ...
    val sampleInput = TransactionInput(
      txid = None,
      vout = None,
      scriptSig = None,
    ...
    val sampleOutput = TransactionOutput(
      txid = None,
      value = Some(50.0),
      n = 0,
    ...
    val sampleInputWithTxid = TransactionInput(
    ...
    val sampleOutputWithTxid = TransactionOutput(
      txid = Some("d6118e27502a9b239c4519351c765667c86b1a4f8ff7592c367e88e4dac63e01"),
      value = Some(50.0),
      n = 0,
      scriptPubKey = ScriptPubKey(
    ...
    val sampleTransaction = Transaction(
      ...
      locktime = 0,
      blocktime = 1294691980,
      vin = List(sampleInput),
      vout = List(sampleOutput)
    )
  }
