...
class TezosDataTest
  ...
  private val conseilOps: TezosConseilOperations = new TezosConseilOperations {
  ...
  val postRoute: Route = TezosData(metadataService, metadataConf, conseilOps, 1000).postRoute

  val getRoute: Route = TezosData(metadataService, metadataConf, conseilOps, 1000).getRoute
